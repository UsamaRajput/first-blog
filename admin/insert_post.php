...
if(isset($_POST['submit']))
{
	...
	$post_imgsh_folder = "post_img/".$post_img_name;
	$post_imgup_folder = "../post_img/".$post_img_name;
	$post_img_tmp = $_FILES['post_img']['tmp_name'];
	
	if ($post_img_type == "image/jpeg" || $post_img_type == "image/png" || $post_img_type == "image/gif")
	{
	 	// Upload Image In Folder
		move_uploaded_file($post_img_tmp, $post_imgup_folder);

	 	// php data insert
	 	$in_query = "INSERT INTO posts (post_title, post_author, post_date, post_image, post_content) VALUES ('$post_title','$post_author','$post_date','$post_imgsh_folder','$post_content')";
